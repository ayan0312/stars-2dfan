import { getHTMLString,IDownloadedInformation,IDownloadImageTypes,downloadImages } from '../../core'
import { ITopicArticle, ITopicArticles } from '../data'
import { getURLRouter, delay, base64, merge, format } from '../../utils'
import Config from '../../config.json'
import { ObjectId } from 'bson'

export async function getTopic(
    subjectDatabaseid: ObjectId,
    topicID?: string,
